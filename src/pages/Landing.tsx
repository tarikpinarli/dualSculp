...
const MODULES = [
  {
    ...
    status: 'ONLINE',
    color: 'cyan',
    videoOverlay: '/videos/apple_steve_shadow.mov'
  },
  // 👇 UPDATED: Replaced the locked Audio tool with the new Meshy tool
  {
    ...
    color: 'purple',
    videoOverlay: '/videos/audio-preview.mp4' // You might want to change this video later
  },
  {
    id: 'litho',
    name: 'Luminance',
